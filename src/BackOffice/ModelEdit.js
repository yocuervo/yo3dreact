...
class ModelEdit extends React.Component {
    ...
    render() {
            ...
            return(
                ...
                <div className="ModelEdit__titulo">Producto Nuevo</div>
                    <form className="ModelEdit__contenedor__nuevo" onSubmit={this.handleSubmit}>
                        <div className="row ModelEdit__row">
                            <div className="col-4">Nombre</div>
                            <div className="col">
                                <input  onChange={this.handleChange}
                                        className="form-control ModelEdit__input"
                        ...
                        <div className="row justify-content-end mr-3 ModelEdit__row">
