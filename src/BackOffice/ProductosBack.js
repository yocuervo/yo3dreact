...
function ProductosBack() {
    return(
        <div className="container-fluid">
            <div className="titulo">Producto Nuevo</div>
                <div className="contenedor__nuevo">
                    <div className="row">
                        <div className="col-4">Nombre</div>
                        <div className="col"><input className="form-control" placeholder="Nombre del modelo" type="text"/></div>
                    </div>
                    <div className="row">
                        <div className="col-4">Alto</div>
                        <div className="col"><input className="form-control" type="number"/></div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="col"><input className="form-control" placeholder="Url Modelador 3D" type="text"/></div>
                    </div>
                    <div className="row">
                        <div className="col-4">Artista</div>
                        <div className="col"><input className="form-control" placeholder="Quien lo pinto" type="text"/></div>
                    </div>
                    <div className="row">
